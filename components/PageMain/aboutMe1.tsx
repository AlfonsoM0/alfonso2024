...
export default function AboutMe1() {
  ...
  return (
    <div className="">
      <div className="flex flex-col justify-center text-shadow shadow-white dark:shadow-black max-w-lg p-5 m-5 hover:bg-[rgba(255,255,255,0.8)] hover:dark:bg-[rgba(0,0,0,0.5)] rounded-2xl">
