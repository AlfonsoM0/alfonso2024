...
export default function AboutMe2() {
  ...
  return (
    <div className="flex flex-col justify-center max-w-lg text-shadow shadow-white dark:shadow-black p-5 m-5 bg-[rgba(255,255,255,0.8)] dark:bg-[rgba(0,0,0,0.5)] rounded-2xl">
